...
<div class="container-fluid">
  <div class="row">
    <div class="col">
      <img src="VISTA/img/imgPrincipal.png" class="img-fluid" alt="imagenPrincipal">
    </div>
    <div class="col">
  ...
  <div class="row d-flex">
        ...
        <div class="card col-4 d-flex align-items-center text-center">
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-footer d-grid">
              <a href="index.php?pagina=talleres" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
      ...
      <div class="card col-4 d-flex align-items-center text-center">
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-footer d-grid">
                <a href="index.php?pagina=productos" class="btn btn-primary">Ver más</a>
              </div>
            </div>
      </div>
      ...
      <div class="card col-4 d-flex align-items-center text-center mb-4 border-0">
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-footer d-grid">
                <a href="index.php?pagina=blog" class="btn btn-primary">Ver más</a>
              </div>
            </div>
        </div>
  ...
  <div id="demo" class="carousel slide mt-2 border-bottom border-1" data-bs-ride="carousel">
    ...
    <div class="carousel-indicators">
      <button type="button" data-bs-target="#demo" data-bs-slide-to="0" class="active bg-danger" aria-label="..."></button>
      <button type="button" data-bs-target="#demo" data-bs-slide-to="1" class="bg-danger"  aria-label="..." alt=".."></button>
      <button type="button" data-bs-target="#demo" data-bs-slide-to="2" class="bg-danger" aria-label="..."  alt=".."></button>
    </div>
