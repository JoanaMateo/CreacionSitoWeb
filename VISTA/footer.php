        ...
        <!-- Grid row -->
            <div class="row mt-3">
                ...
                <!-- Links -->
                    ...
                    <p>
                        <a href="index.php?ofertas=1" class="text-reset">Ofertas</a>
                    </p>
                </div>
                <!-- Grid column -->
                ...
                <!-- Links -->
                    ...
                    <p>
                    <a href="index.php?pagina=aboutUs"  class="text-reset">Quienes somos</a>
                    </p>
                    <p>
                    <a href="index.php?pagina=contacto"  class="text-reset">Contáctanos</a>
                    </p>
                    <p>
                    <a href="index.php?pagina=preguntasFrecuentes"  class="text-reset">Preguntas Frecuentes</a>
                    </p>
                    <p>
